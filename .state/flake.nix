{
  inputs = {
    ...
    icedos-github_icedos_apps-me3-me3 = {
      inputs = {
        nixpkgs = {
          follows = "nixpkgs";
        };
    ...
    icedos-github_icedos_cosmic = {
      url = "github:icedos/cosmic/3c564ef73a65e935e96c0b372ce1eeb4ebeced77";
    };
    ...
    icedos-github_icedos_hardware = {
      url = "github:icedos/hardware/0c9cee5a1328619ff13742ce6ff2ccbbf6c1ceac";
    };
